	...
	__nest__ (
		...
		'main.authenticate', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var __name__ = 'main.authenticate';
					var EventDispatcher = __init__ (__world__.main.util).EventDispatcher;
					var AuthenticationArea = __class__ ('AuthenticationArea', [object], {
						__module__: __name__,
						get __init__ () {return __get__ (this, function (self, area) {
							self.select = (function __lambda__ () {
								return $ (area);
							});
						...
						get __initializeUI () {return __get__ (this, function (self) {
							...
							if (!(user)) {
								...
								self.select ().find ('[name="logged-in"] [name="email"]').text (user.email);
							}
						});},
	...
	__nest__ (
		...
		'main.displayer', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var __name__ = 'main.displayer';
					var Displayer = __class__ ('Displayer', [object], {
						__module__: __name__,
						get __init__ () {return __get__ (this, function (self, authenticator) {
							self.authenticator = authenticator;
							self.authenticator.eventLogin.append (self.__initialize);
							self.authenticator.eventLogin.append ((function __lambda__ () {
								return self.__toggle (true);
							}));
							self.authenticator.eventLogout.append ((function __lambda__ () {
								return self.__toggle (false);
							}));
							self.initialized = false;
						});},
						get __toggle () {return __get__ (this, function (self, v) {
							$ ('[data-auth-display-toggle]').toggle (v);
						});},
						get __initialize () {return __get__ (this, function (self) {
							...
							var interests = list ($ ('[data-auth-display]'));
							var __iterable0__ = interests;
							for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
								var each = __iterable0__ [__index0__];
								var path = $ (each).attr ('data-auth-display');
								var template = $ (each).attr ('data-auth-display-template');
								var targetAttr = $ (each).attr ('data-auth-display-attribute');
								var useHtml = $ (each).attr ('data-auth-display-html');
								self.__bindListener (each, path, template, targetAttr, useHtml);
							}
							self.initialized = true;
						});},
						get __bindListener () {return __get__ (this, function (self, domObj, path, template, targetAttr, useHtml) {
							if (!(template)) {
								var template = '{}';
							}
	...
	__nest__ (
		...
		'main.util', {
			__all__: {
				__inited__: false,
				__init__: function (__all__) {
					var __name__ = 'main.util';
					var EventDispatcher = __class__ ('EventDispatcher', [object], {
						__module__: __name__,
						get __init__ () {return __get__ (this, function (self) {
							self.__list = list ([]);
						});},
						get append () {return __get__ (this, function (self, what) {
							self.__list.append (what);
						});},
						get call () {return __get__ (this, function (self) {
							var args = tuple ([].slice.apply (arguments).slice (1));
							var build = (function __lambda__ (func, args) {
								return (function __lambda__ () {
									return func.apply (null, args);
								});
							});
							var __iterable0__ = self.__list;
							for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
								var func = __iterable0__ [__index0__];
								var l = build (func, args);
								setTimeout (l, 1);
							}
						});}
					});
